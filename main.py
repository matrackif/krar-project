...
if __name__ == '__main__':
    ...
    parser.add_argument('-l', '--library-file', nargs='?', type=str, default='example/Example3b/lib.adl3',
                        const='example/lib.adl3', help='Path to input ADL3 domain description file')
    parser.add_argument('-s', '--scenario-file', nargs='?', type=str, default='example/Example3b/scenario.txt',
                        const='example/scenario.txt', help='Path to input ADL3 scenario file')
    parser.add_argument('-q', '--query-file', nargs='?', type=str, default='example/Example3b/queries.txt', help='Query file to be parsed')
